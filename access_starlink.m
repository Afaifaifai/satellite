...
while sc.SimulationTime < endTime
    ...
    % 寫出 CSV 檔
    writematrix(coords,        sprintf('./data/starlink/coords_%03d.csv',        idx));
    writematrix(access_states, sprintf('./data/starlink/access_states_%03d.csv', idx));
    writematrix(distances,     sprintf('./data/starlink/distances_%03d.csv',     idx));
